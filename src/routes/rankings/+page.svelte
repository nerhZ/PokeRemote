    ...
    {:else}
        <div class="space-y-2">
            {#each activeList as entry, i}
                <a href="/pokemon/{entry.name}" class="flex items-center gap-3 p-3.5 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-white/20 hover:bg-white/[0.05] transition-all no-underline group">
